...
让 X 更清爽：在本地模糊或隐藏嘈杂回复、时间线推文和广告，并可用 Makeover 清理页面；不读取 cookie，也不修改账号。
...
- 提供 Makeover 页面改造，可隐藏推荐、推广内容、页脚、计数器和导航等干扰元素。
- 支持过滤推广推文、媒体广告、网站卡片广告，以及 X 标记的仿冒、粉丝、评论和自动化账号。
